  ...
  icono={"far fa-keyboard"}
   > 
                 <div className="form__container">
                  ...
                  <input className="form__input form__input--nombre local--input--name" id="nombre" type="text" name="name" placeholder="Ej. Martirio"
                    maxlength="19" data-donde="element-nombre"/>
                  <label className="form__label" for="puesto">Puesto</label>
                  <input className="form__input form__input--puesto local--input--job" id="puesto" type="text" name="job" placeholder="Ej. Reina de la canción"
                    maxlength="22" data-donde="element-puesto"/>
                  ...
                  <input className="form__input inputhref form__mail local--input--email" id="email" type="mail" name="email" placeholder="Ej. reinadelacancion@ole.es"
                    data-donde="element-email" href=""/>
                  <label className="form__label" for="telefono">Teléfono</label>
                  <input className="form__input inputhref form__telefono local--input--phone" id="telefono" type="number" name="phone" placeholder="Ej. 982938437"
                    data-donde="element-telefono"/>
                  <label className="form__label " for="linkedin">Linkedin</label>
                  <input className="form__input inputhref form__linkedin local--input--linkedin" id="linkedin" type="text" name="linkedin" placeholder="Ej. martirio.reina"
                    data-donde="element-linkedin"/>
                  <label className="form__label" for="github">Github</label>
                  <input className="form__input inputhref form__github local--input--github" id="github" type="text" name="github" placeholder="Ej. martirio-reina"
            ...
            <div className="form__fill colapsable--visible" data-donde="2">
